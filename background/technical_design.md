...
每个已发布互动机会还必须登记玩家可见的 `opening_narrative` 与 `conversation_goal`。前者说明本次为何能见到该人物、地点与前情如何衔接，后者只提示当前可谈方向，不泄露隐藏动机或未解锁事实。发布校验要求 32 个机会全部非空；吴秀英首次会谈严格采用最终剧本中的“下村走访时在坡上偶遇、拎菜篮、老教师受人敬重”场景，巡察组 D31 与环保迎检组 D59 分别使用独立背景，禁止混用机构和时间。

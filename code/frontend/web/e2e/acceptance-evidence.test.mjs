...
const validAuditPage = () => ({
  ...
  audits: [
    ...
    { audit_id: "llm_draft", session_id: "session-1", run_id: "session-1", operation_id: "m-1:draft-document:expression", provider: "openai_compatible", model: "model-1", endpoint_host: "api.example.test", config_version: "cfg-1", status: "succeeded", error_code: null, timestamp: "2026-08-31T12:00:02Z" },
    { audit_id: "llm_sign_choice", session_id: "session-1", run_id: "session-1", operation_id: "d-1:countersign:npc-1:v1:choice", provider: "openai_compatible", model: "model-1", endpoint_host: "api.example.test", config_version: "cfg-1", status: "succeeded", error_code: null, timestamp: "2026-08-31T12:00:03Z" },
    { audit_id: "llm_sign_expression", session_id: "session-1", run_id: "session-1", operation_id: "d-1:countersign:npc-1:v1:expression", provider: "openai_compatible", model: "model-1", endpoint_host: "api.example.test", config_version: "cfg-1", status: "succeeded", error_code: null, timestamp: "2026-08-31T12:00:04Z" },
  ],
});

...
总体风格必须以 `docs/product/美术设计/设计参考/` 中的参考图为基准。当前参考图呈现的是“政务档案式严肃游戏界面”：深色外框、旧纸张面板、手绘流域地图、半写实水彩人物肖像、档案盒、红章批注、会议材料和基层办公室环境共同构成统一视觉。
...
所有人物必须与 `docs/product/美术设计/设计参考/` 的 UI 和场景风格一致。
